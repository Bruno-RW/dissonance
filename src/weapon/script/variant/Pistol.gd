...
#~Bullet
var bullet_script: Script = preload("res://src/weapon/script/Bullet.gd")
var bullet_scene: PackedScene = preload("res://src/weapon/scene/Bullet.tscn")
...
func _fire_shockwave_projectile() -> void:
	var bullet = _instantiate_bullet_scene()
...
#? === === === BULLET SPAWNING METHODS === === === ?#
func _instantiate_bullet_scene() -> Node:
