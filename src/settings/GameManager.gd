...
enum WeaponType { PISTOL, SHOTGUN, SNIPER, SUBMACHINE }
...
var selected_weapon: WeaponType = WeaponType.PISTOL

var character_scenes: Dictionary = {
	CharacterType.ASSAULT: preload("res://src/player/scene/variant/Assault.tscn"),
	# CharacterType.SUPPRESSION: preload("res://src/player/scene/variant/SuppressionUnit.tscn"),
	# CharacterType.PRECISION: preload("res://src/player/scene/variant/PrecisionUnit.tscn"),
	# CharacterType.INFILTRATION: preload("res://src/player/scene/variant/InfiltrationUnit.tscn")
}

var weapon_scenes: Dictionary = {
	WeaponType.PISTOL: preload("res://src/weapon/scene/variant/Pistol.tscn"),
	# WeaponType.SHOTGUN: preload("res://src/weapon/scene/variant/Shotgun.tscn"),
	# WeaponType.SNIPER: preload("res://src/weapon/scene/variant/Sniper.tscn"),
	# WeaponType.SUBMACHINE: preload("res://src/weapon/scene/variant/Submachine.tscn")
}
...
func start_game() -> void:
	...
	#? 4. Instance the selected Weapon and attach to player
	var weapon_scene = weapon_scenes[selected_weapon]
	var weapon_instance = weapon_scene.instantiate()

	player_instance.add_child(weapon_instance)
